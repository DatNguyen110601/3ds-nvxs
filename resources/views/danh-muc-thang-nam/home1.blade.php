            ...
            <div class="d-flex">
                <div class="row g-3">
                    ...
                    <div class="col-auto" >
                        ...
                        <select id="phong_ban" name="phong_ban">
                    ...
                    @foreach ($data['diemThangs']  as $key=>$value)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                $idViTriNhanVien = optional($value['diemThang']->nhanVien->viTri->first())->id;
                                $viTriCapTren = in_array($idViTriNhanVien, $listIDCapDuoi);
                                ?>


                            @if ($user->hasRole('Admin') || auth()->user()->quyenHr() || $viTriCapTren )
                                    @if ($value['diemThang']->tong_diem == 0)
